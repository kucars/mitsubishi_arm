...
class JointTrajectoryActionServer(object):
  ...
  def __init__(self, name):
    ...
    self.joint_states_msg.name=['j1','j2','j3','j4','j5','j6','finger_1_prox_joint', 'finger_1_med_joint', 'finger_1_dist_joint', 'finger_2_prox_joint', 'finger_2_med_joint', 'finger_2_dist_joint', 'finger_3_med_joint', 'finger_3_dist_joint']
  ...
  def publish_last_state(self):
        self.last_joint_states_msg.header.stamp=rospy.Time.now()
        ...
        for i in nbuffer:
         ...
         if i != '':
          try:
           ...
           return
        print self.joint_states_msg.header.stamp
        if len(self.joint_states_msg.position)!=6:
          return

        for i in range(8):
          self.joint_states_msg.position.append(0.0) # dummy barret
